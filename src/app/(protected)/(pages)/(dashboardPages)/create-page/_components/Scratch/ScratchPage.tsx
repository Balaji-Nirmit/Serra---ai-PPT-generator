...
const ScratchPage = ({ onBack }: Props) => {
    ...
    const handleGenerate = async () => {
        if(outlines.length===0){
            toast.error("Error",{
                description:"Please add at least one card to generate a presentation."
            })
            return;
        }
                ...
                >
                    <div className="flex flex-col sm:flex-row justify-between gap-3 items-center rounded-xl">
                        <Input value={editText} 
                            ...
                            placeholder="Enter your prompt here" className="text-base sm:text-xl border-0 focus-visible:ring-0 shadow-none p-0 bg-transparent flex-grow"
                        />
