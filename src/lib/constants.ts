import { Settings, Trash, LayoutTemplate as Template, Home } from "lucide-react";
import {
  BlankCard,
  AccentLeft,
  AccentRight,
...
export const itemVariants = {
  ...
  visible: {
    ...
    opacity: 1,
    transition: {
      // ✅ The string literal "spring" is the fix.
      type: "spring" as const, // Or use the explicit literal, which TS usually infers
      stiffness: 100,
    },
  },
};
