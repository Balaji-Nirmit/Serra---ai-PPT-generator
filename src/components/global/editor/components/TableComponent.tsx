...
const TableComponent=({content,onChange,isPreview,isEditable,initialColSize,initialRowSize}:TableComponentProps)=>{
                    ...
                    <React.Fragment key={rowIndex}>
                        ...
                        >
                            ...
                            <React.Fragment key={colIndex}>
                                ...
                                <ResizablePanel defaultSize={colSizes[colIndex]}
                                onResize={(size)=>handleResizeCol(colIndex,size)} className="w-full h-full min-h-9"
                                >
